...
@WebServlet(name = "registrarOfertaEmprendedor", urlPatterns = {"/registrarOfertaEmprendedor"})

public class RegistrarOfertaEmprendedorServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int CantidadLimite = Integer.parseInt(req.getParameter("CantidadLimite"));
        System.out.println("CantidadLimite = " + CantidadLimite);
        Float Monto = Float.valueOf(req.getParameter("Monto"));
        ...
        String LogotipoNegocio = req.getParameter("LogotipoNegocio");
        ...
        try {
            ...
            // Cierra la conexión
            if (regOferta != null || regEmprendedor != null) {
                regOferta.cerrarConexion();
                regEmprendedor.cerrarConexion();
            }
        }
    }
