...
import pe.edu.utp.html.DashboardEmprendedorHTML;
import pe.edu.utp.html.ErrorHTML;

import java.io.IOException;

@WebServlet(name = "dashboardEmprendedor", urlPatterns = {"/dashboardEmprendedor"})
public class DashboardEmprendedorServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (ses.getAttribute("is_valid_user") != null) {
            ...
            if (is_valid_user) {
                ...
                String htmlDashboard = DashboardEmprendedorHTML.showDashboard(username);
